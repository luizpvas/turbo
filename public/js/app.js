...
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ({
  successFromElement: function successFromElement(element, message) {
    ...
    elm.className = "absolute bg-white shadow border rounded p-1 text-sm text-green-dark";
...
var map = {
	...
	"./attachment_item_controller.js": "./resources/js/controllers/attachment_item_controller.js",
	"./attachments_controller.js": "./resources/js/controllers/attachments_controller.js",
	...
	"./tags_controller.js": "./resources/js/controllers/tags_controller.js"
};
...
/***/ "./resources/js/controllers/attachment_item_controller.js":
/*!****************************************************************!*\
  !*** ./resources/js/controllers/attachment_item_controller.js ***!
  \****************************************************************/
/*! exports provided: default */
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function connect() {
      ...
      this.deleteTarget.addEventListener("click", function (ev) {
        ev.preventDefault();
        console.log("delete clicked");
      });
      this.copyTarget.addEventListener("click", function (ev) {
        ev.preventDefault();
        var input = document.createElement("input");
        input.value = _this.copyTarget.href;
        document.body.appendChild(input);
        input.select();
        document.execCommand("copy");
        document.body.removeChild(input);
        _alert__WEBPACK_IMPORTED_MODULE_1__["default"].successFromElement(_this.copyTarget, "URL copied to the clipboard.");
      });
    }
  }]);
...
_defineProperty(_default, "targets", ["delete", "copy"]);



/***/ }),

/***/ "./resources/js/controllers/attachments_controller.js":
/*!************************************************************!*\
  !*** ./resources/js/controllers/attachments_controller.js ***!
  \************************************************************/
/*! exports provided: default */
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function connect() {
      ...
      this.counter = 0;
      this.dropTarget.addEventListener("dragenter", function (ev) {
        _this.counter += 1;
        console.log("enter");
        ev.preventDefault();
        ev.stopPropagation();
    ...
    value: function uploadFile(file) {
      ...
      var url = "/websites/".concat(this.data.get("websiteId"), "/attachments");
      ...
      xhr.addEventListener("readystatechange", function (e) {
        if (xhr.readyState == 4 && xhr.status == 200) {
          ...
          _this2.outputTarget.insertAdjacentHTML("afterbegin", _data.item);
        } else if (xhr.readyState == 4 && xhr.status != 200) {
          console.log("something went wrong");
        }

        _this2.clearProgress();
      });

      xhr.upload.onprogress = function (ev) {
        console.log("progress...");
        var pct = Math.ceil(ev.loaded / ev.total * 100);

        _this2.renderProgress(pct);
      };
    ...
    key: "renderProgress",
    value: function renderProgress(pct) {
      this.progressTarget.innerHTML = "\n          <div class=\"bg-grey-light h-4 w-full rounded\">\n            <div class=\"bg-blue h-4 rounded\" style=\"width: ".concat(pct, "%;\"></div>\n          </div>\n        ");
    }
  }, {
    key: "clearProgress",
...
_defineProperty(_default, "targets", ["drop", "progress", "output"]);
...
/* harmony import */ var turbolinks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! turbolinks */ "./node_modules/turbolinks/dist/turbolinks.js");
/* harmony import */ var turbolinks__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(turbolinks__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _turbolinks_laravel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../turbolinks_laravel */ "./resources/js/turbolinks_laravel.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
  ...
  _createClass(_default, [{
    ...
    value: function connect() {
      ...
      this.inputs.forEach(function (node) {
        node.addEventListener("blur", function (ev) {
          if (node.classList.contains("field__input--error") && node.value.length > 0) {
            _this.clearInputValidation(node);
          }
        });
      });
    }
    ...
    value: function onSubmit(ev) {
      ...
      if (this.submitTarget.hasAttribute("data-additional-attributes")) {
        try {
          var attrs = JSON.parse(this.submitTarget.getAttribute("data-additional-attributes"));
      ...
      fetch(this.element.action, {
        ...
        _this2.restoreSubmitFromLoading();

        if (_turbolinks_laravel__WEBPACK_IMPORTED_MODULE_2__["default"].isRedirect(res)) {
          _turbolinks_laravel__WEBPACK_IMPORTED_MODULE_2__["default"].followRedirect(res);
        } else {
          _this2.showValidationErrors(res.errors);
        }
      });
    }
  }, {
    key: "followRedirect",
    value: function followRedirect(url) {
      turbolinks__WEBPACK_IMPORTED_MODULE_1___default.a.visit(url, {
        action: "replace"
      });
    }
  }, {
    ...
    value: function clearValidation() {
      Array.from(this.element.querySelectorAll(".field__input--error")).forEach(this.clearInputValidation);
    }
  }, {
    key: "clearInputValidation",
    value: function clearInputValidation(input) {
      input.classList.remove("field__input--error");
      var validation = input.parentNode.querySelector(".field__validation");
    ...
    key: "updateSubmitToLoading",
    value: function updateSubmitToLoading() {
      this.submitHTML = this.submitTarget.innerHTML;
      this.submitTarget.innerHTML = "Loading...";
    }
  }, {
    key: "restoreSubmitFromLoading",
    value: function restoreSubmitFromLoading() {
    ...
    value: function showValidationErrors(errors) {
      ...
      Object.keys(errors).forEach(function (name) {
        var input = _this3.element.querySelector("[name=\"".concat(name, "\"]"));
...
/***/ "./resources/js/controllers/html_editor_controller.js":
/*!************************************************************!*\
  !*** ./resources/js/controllers/html_editor_controller.js ***!
  \************************************************************/
/*! exports provided: default */
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function connect() {
      ...
      this.ensureTrixLoaded(function () {
        _this.element.querySelector("trix-editor").addEventListener("trix-change", function (ev) {
          _this.textTarget.value = _this.element.querySelector("trix-editor").editor.getDocument().toString();
        });
      });
    }
  }, {
...
_defineProperty(_default, "targets", ["html", "text"]);



/***/ }),

/***/ "./resources/js/controllers/remote_link_controller.js":
/*!************************************************************!*\
  !*** ./resources/js/controllers/remote_link_controller.js ***!
  \************************************************************/
/*! exports provided: default */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return _default; });
/* harmony import */ var stimulus__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! stimulus */ "./node_modules/stimulus/index.js");
/* harmony import */ var _turbolinks_laravel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../turbolinks_laravel */ "./resources/js/turbolinks_laravel.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
    ...
    value: function connect() {
      ...
      this.element.addEventListener("click", function (ev) {
        ...
        fetch(_this.element.href, {
          ...
          _turbolinks_laravel__WEBPACK_IMPORTED_MODULE_1__["default"].followRedirect(res);
        });
      });
    }
  }, {
...
/***/ "./resources/js/controllers/tags_controller.js":
/*!*****************************************************!*\
  !*** ./resources/js/controllers/tags_controller.js ***!
  \*****************************************************/
/*! exports provided: default */
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    key: "removeTag",
    value: function removeTag(tagLabel) {
      this.tags = this.tags.filter(function (_ref) {
        var tag = _ref.tag;
        return tagLabel != tag;
      });
      this.render();
    ...
    value: function render() {
      ...
      var html = this.tags.map(function (_ref2) {
        var tag = _ref2.tag;
        return "\n            <input type=\"checkbox\" class=\"hidden\" name=\"tags[]\" value=\"".concat(tag, "\" checked>\n            <div class=\"inline-block bg-indigo text-white rounded font-bold text-xs py-px px-1\">\n              ").concat(tag, "\n              <i class=\"fas fa-times text-indigo-lighter ml-1 cursor-pointer\" data-remove=\"").concat(tag, "\"></i>\n            </div>\n            ");
      });
      this.outputTarget.innerHTML = html.join("");
      Array.from(this.outputTarget.querySelectorAll("[data-remove]")).forEach(function (elm) {
        elm.addEventListener("click", function (ev) {
          var tag = elm.getAttribute("data-remove");
...
/***/ "./resources/js/turbolinks_laravel.js":
/*!********************************************!*\
  !*** ./resources/js/turbolinks_laravel.js ***!
  \********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = ({
  install: function install() {
    ...
    document.addEventListener("turbolinks:load", function (ev) {
      if (_this.flash) {
        console.log("applying flash", _this.flash);
      }

      _this.flash = null;
    });
  },
  isRedirect: function isRedirect(json) {
    return json.redirect;
  },
  followRedirect: function followRedirect(json) {
    this.flash = json.flash;
    turbolinks__WEBPACK_IMPORTED_MODULE_0___default.a.visit(json.redirect, {
      action: "replace"
    });
  }
});
...
__webpack_require__(/*! /home/luiz/Projects/_old/turbo_laravel/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/luiz/Projects/_old/turbo_laravel/resources/css/app.css */"./resources/css/app.css");
